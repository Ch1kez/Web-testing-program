...
<!--
  <urn1:Mnemonic>RUOWNER000017</urn1:Mnemonic>
                  <urn1:HumanReadableName>АО "ЭЛЕКТРОННЫЙ ПАСПОРТ"</urn1:HumanReadableName>
    -->              
               </urn1:Sender>
                  ...
                  <doc:ELPTSOwnerAppRequest>
                     ...
                     <doc:SignersList>
                        ...
                        <ccdo:OwnerOrganizationDetails>
                           ...
                           <csdo:OrganizationName>Акционерное общество "ПЕП"</csdo:OrganizationName>
                           <ccdo:OrganizationId kindId="1">2112502065740</ccdo:OrganizationId>
                           <ccdo:OrganizationTaxpayerId>0882540701</ccdo:OrganizationTaxpayerId>
                           <csdo:TaxRegistrationReasonCode>070643219</csdo:TaxRegistrationReasonCode>
                        </ccdo:OwnerOrganizationDetails>
                        <doc:CommunicationDetails CommunicationChannelCode="EM">125@elpts.ru</doc:CommunicationDetails>
                     </doc:SignersList>
                  </doc:ELPTSOwnerAppRequest>
               </urn1:MessagePrimaryContent>
               <urn1:PersonalSignature></urn1:PersonalSignature>
               <!--первая подпись (должностное лицо)-->
            </urn1:SenderProvidedRequestData>
            <urn1:SenderInformationSystemSignature></urn1:SenderInformationSystemSignature>
